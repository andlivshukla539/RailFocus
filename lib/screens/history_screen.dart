            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.delete_outline_rounded,
                    color: Color(0xFFB83838), size: 36),
  ...
  void _deleteSession(JourneySession session) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Journey deleted',
          style: GoogleFonts.cormorant(color: _P.cream),
        ),
                    ...
                    background: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 8),
                          const Icon(Icons.delete_outline_rounded,
                              color: Color(0xFFB83838), size: 20),
                        ],
                      ),
                    ),
                    child: _JourneyCard(
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: session.completed
                                        ...
                                        : _P.warning.withValues(alpha: 0.15),
